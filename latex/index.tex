...
To use the custom memory manager in your project, include {\ttfamily \doxylink{sfpool_8h_source}{sfpool.\+h}} and use the provided functions.\hypertarget{index_autotoc_md3}{}\doxysubsubsection{\texorpdfstring{High Level API}{High Level API}}\label{index_autotoc_md3}
